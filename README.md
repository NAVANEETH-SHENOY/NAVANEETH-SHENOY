...
- 🚀 Actively building projects, competing in hackathons, and chasing internships
- 📫 Open to ML programs, internships, and collaborations
...
| Project | Description |
|---|---|
| **VAE & DDPM from Scratch** | Implemented a Variational Autoencoder and Denoising Diffusion Probabilistic Model from the ground up in PyTorch |
| **FitSense** | AI-powered fitness planner combining Google Gemini with fuzzy logic for personalized recommendations |
| **AgriTech Crop Price Forecasting** | XGBoost-based model to predict crop prices for better agricultural decision-making |
...
<p align="center">
  <i>"Learning by building — one model, one bug, one breakthrough at a time."</i>
</p>
